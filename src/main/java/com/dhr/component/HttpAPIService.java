...
public class HttpAPIService {
     ...
     * @throws Exception
     */
    public String doGet(String url, Map<String, Object> headers) throws Exception {
        // 声明 http get 请求
     ...
     * @throws Exception
     */
    public String doGet(String url, Map<String, Object> map, Map<String, Object> headers) throws Exception {
